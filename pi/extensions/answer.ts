 ...
 *
 * Vendored just to set the model to gpt-5.4-mini instead of the gpt-5.3 that isn't available on codex
 * @see https://github.com/mitsuhiko/agent-stuff/blob/19abb5afc61269d1ddbec39047a9e93faa70bd0d/extensions/answer.ts
 */
