#!/usr/bin/env bash
# sync.sh — update all skills in pi/skills/ from upstream repos
#
...
add_skill() {
  ...
  # Move from staging into pi/skills/
...
echo "Syncing skills into pi/skills/..."
...
echo ""
echo "Done. Skills are in pi/skills/"
